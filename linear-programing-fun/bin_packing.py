#Bin packing
# Given n items with weights 1 w 1 w n
# and an arbitrary number of bins with maximum 
# carry weight C, determine the 
# lowest number of bins that can contain 
# all the items without exceeding their carry weight.
#
# python3.10 bin_packing.py
#
from pulp import *
