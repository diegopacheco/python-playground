...
class HouseStoreTest(unittest.TestCase):
    ...
    def test_new_order_starts_as_ordered_with_catalog_details(self):
    ...
    def test_house_moves_through_every_construction_stage_in_order(self):
    ...
    def test_a_delivered_house_cannot_move_again(self):
    ...
    def test_unknown_model_is_rejected_so_no_webhook_carries_an_unpriced_house(self):
        with self.assertRaises(ValueError):
            self.store.create("castle", "Lot Z-99", "buyer-0099")

    def test_lot_and_buyer_alias_are_required(self):
        with self.assertRaises(ValueError):
            self.store.create("aspen", "", "buyer-0001")

    def test_unknown_house_is_not_found(self):
        with self.assertRaises(HouseNotFound):
            self.store.advance("00000000-0000-0000-0000-000000000000")

    def test_only_the_final_stage_emits_house_delivered(self):
