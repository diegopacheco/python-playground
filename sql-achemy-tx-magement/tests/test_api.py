...
TX_NOTES = [
    ...
    ("why one check is not three", "_guard(self)", None),
    ...
    ("what happens when the boundary cannot ask", "async def _still_committable", "UNVERIFIABLE"),
    ...
    ("arms the nets before any of the code", "await _open(context.session)", None),
